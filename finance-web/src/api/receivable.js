...
/** 业财一体：销售发票生成记账凭证 */
export const invoiceVoucher = (id) => request({ url: '/receivable/invoice/' + id + '/voucher', method: 'post' })
...
/** 业财一体：收款单生成记账凭证 */
export const receiptVoucher = (id) => request({ url: '/receivable/receipt/' + id + '/voucher', method: 'post' })
