...
/** 业财一体：采购发票生成记账凭证 */
export const apInvoiceVoucher = (id) => request({ url: '/payable/invoice/' + id + '/voucher', method: 'post' })
...
/** 业财一体：付款单生成记账凭证 */
export const paymentVoucher = (id) => request({ url: '/payable/payment/' + id + '/voucher', method: 'post' })
...
export const supplierAging = (id) => request({ url: '/payable/aging/' + id, method: 'get' })